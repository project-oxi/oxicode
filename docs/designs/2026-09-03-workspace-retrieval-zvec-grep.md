...
**Status:** Adopted — Phase 2 skeleton shipped (2026-09-04): opt-in
`workspace_search` tool, `BrainWorkspaceSearch` over the oxibrain document
plane, settings gate, conditional registration, and prompt fragment.
Paired baseline/treatment evaluations remain outstanding (Phase 3 gate).
**Date:** 2026-09-03  
